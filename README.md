...
Chlorine is a Fake virus not a real virus,
Chlorine works by using an app for iphones
and Ipad (IOS IpadOS and MacOS is only supported
For this due to this using the shortcuts app
which is only for iphone Ipad and MacOS for now
I guess.

Now Dont Worry! this repository will get 
updates and is not intended for harm!
